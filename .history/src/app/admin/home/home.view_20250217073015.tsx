      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {alat.map((item) => (
          ...
          >
            ...
            <a href="/" className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300">
              Rent Now
            </a href="/">
          </div>
        ))}
