...
const RentalForm = () => {
  ...
  const [selectedJenis, setSelectedJenis] = useState(""); // Untuk menyimpan jenis pelanggan yang dipilih
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validasi input
      if (!formData.pelanggan_nama || !formData.pelanggan_noTelp || !formData.pelanggan_email || !selectedJenis) {
        setError("Semua field harus diisi, termasuk jenis pelanggan.");
        return;
      }
      ...
      const payload = {
        ...formData,
        pelanggan_data_jenis: selectedJenis, // Tambahkan jenis pelanggan ke payload
      };
      await addPelanggan(payload).unwrap();
      ...
      setSelectedJenis(""); // Reset dropdown
    } catch (err: any) {
