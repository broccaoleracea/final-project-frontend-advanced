...
const RentalForm = () => {
  ...
  const [selectedJenis, setSelectedJenis] = useState(""); // Untuk menyimpan jenis pelanggan dari dropdown
  ...
  const [addPelangganData, { isLoading: isAdding }] = usePelangganDataPostMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validasi input
      if (!formData.pelanggan_nama || !formData.pelanggan_noTelp || !formData.pelanggan_email || !selectedJenis || !file) {
      ...
      toSubmit.append("pelanggan_data_id", selectedJenis); // ID jenis pelanggan dari dropdown
      toSubmit.append("pelanggan_data_file", file); // File yang diunggah
      toSubmit.append("pelanggan_nama", formData.pelanggan_nama);
      toSubmit.append("pelanggan_alamat", formData.pelanggan_alamat);
      toSubmit.append("pelanggan_noTelp", formData.pelanggan_noTelp);
      toSubmit.append("pelanggan_email", formData.pelanggan_email);
            ...
            <div className="relative">
              ...
              {isPelangganLoading ? (
                ...
                >
                  ...
                  {pelangganResponse?.data?.map((jenis) => (
                    <option key={jenis.pelanggan_data_id} value={jenis.id}>
                      {jenis.nama_jenis}
                    </option>
                  ))}
                </select>
