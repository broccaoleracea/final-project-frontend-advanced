  "use client";
  import { usePelangganDataGetQuery, usePelangganPostMutation } from "@/state/api/dataApi";
  ...
  const RentalForm = () => {
    const [formData, setFormData] = useState({
      ...
      const { data: dataResponse, isLoading: isDataLoading, isError: isDataError } =
      usePelangganDataGetQueryGetQuery();
