    ...
    <div className="flex min-h-screen bg-gray-100">
      <div className="w-full p-8">
        ...
        <Link
            ...
            className="px-6 py-3 mb-10  bg-gradient-to-r from-yellow-400 to-yellow-500 text-white font-semibold rounded-lg shadow-md hover:from-yellow-500 hover:to-yellow-600 transition duration-300 ease-in-out"
          >
            Tambah Pelanggan
          </Link>
