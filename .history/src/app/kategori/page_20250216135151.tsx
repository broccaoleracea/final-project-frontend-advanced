        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {['pencahayaan', 'pendingin ruangan', 'kamera', 'handphone', 'laptop'].map((kategori) => (
            <div
              ...
              className="p-4 rounded-lg shadow-md bg-white dark:bg-gray-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300"
            >
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{kategori.charAt(0).toUpperCase() + kategori.slice(1)}</h3>
            </div>
          ))}
        </div>
      )}
