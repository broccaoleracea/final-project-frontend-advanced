    ...
    <div className="p-4 min-h-screen bg-gray-100 overflow-y-auto ml-64">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          ...
          className="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-white font-semibold rounded-lg shadow-md focus:ring-2 focus:ring-yellow-400"
        >
          Tambah Penyewaan
        </Link>
      </div>
      ...
      <div className="overflow-hidden border border-gray-300 rounded-lg shadow-md bg-white">
        <table className="w-full border-collapse text-sm">
          <thead className="bg-gradient-to-r from-blue-200 to-indigo-200 text-gray-800">
            <tr>
              <th className="py-2 px-3 text-left font-semibold border-b border-gray-300">
                Nama Barang
              </th>
              <th className="py-2 px-3 text-left font-semibold border-b border-gray-300">
                Penyewa
