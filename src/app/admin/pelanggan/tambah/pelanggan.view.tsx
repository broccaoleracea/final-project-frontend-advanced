...
const pelangganData = pelangganResponse?.data as Pelanggan | Pelanggan[] | undefined;
const pelangganId = Array.isArray(pelangganData)
  ? pelangganData[0]?.pelanggan_id
  : pelangganData?.pelanggan_id;


      if (!pelangganId) throw new Error("Gagal mendapatkan ID pelanggan.");

      const formDataWithFile = new FormData();
      formDataWithFile.append("pelanggan_data_pelanggan_id", pelangganId.toString());
